...
LUA_SHA1 = get_hash(os.path.join(CWD, 'mangaz.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--header', 'Cookie: MANGAZ[age]=Q2FrZQ%3D%3D.To0%3D'
        ]
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'book':
                ...
                wget_args.append('https://r18.mangaz.com/authors/detail/'+item_value)
            elif item_type == 'index':
                wget_args.extend(['--warc-header', 'mangaz-index-params: '+item_value])
                wget_args.append('https://r18.mangaz.com/title/index?'+item_value)
            elif item_type == 'info':
                wget_args.extend(['--warc-header', 'mangaz-info: '+item_value])
                wget_args.append('https://closing.mangaz.com/info/{}/index.html'.format(item_value))
            else:
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/2/27/Mangaz-icon.png" height="50px" title=""/>
        <h2>マンガ図書館Z <span class="links"><a href="https://www.mangaz.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/mangaz/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/マンガ図書館Z">Wiki</a></span></h2>
        <p>Archiving マンガ図書館Z.</p>
    '''
)
